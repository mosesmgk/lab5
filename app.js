...
async  function getRandomImage(keyword, count){
        return new Promise (function (resolve, reject)  {
            let requestUrl =  `https://api.unsplash.com/photos/random/?count=${count}&client_id=FviJa7-tt35hr9bpC5mz69tx8RiEJHJAnS3s3F6bWpw&featured=true&orientation=landscape&query=${keyword}`;
